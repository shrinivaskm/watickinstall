...
backend_redis_create() {
  print_banner
  printf "${WHITE} 💻 Creating Redis & Postgres Database...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_set_env() {
  print_banner
  printf "${WHITE} 💻 Setting backend environment variables...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_update() {
  print_banner
  printf "${WHITE} 💻 Updating backend...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_db_migrate() {
  print_banner
  printf "${WHITE} 💻 Running db:migrate...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_db_seed() {
  print_banner
  printf "${WHITE} 💻 Running db:seed...${GRAY_LIGHT}"
  printf "\n\n"
...
backend_start_pm2() {
  print_banner
  printf "${WHITE} 💻 Starting pm2 (backend)...${GRAY_LIGHT}"
  printf "\n\n"
