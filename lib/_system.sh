...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Let's delete the whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Removal of the Instance/Company ${empresa_delete} successfully carried out...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Let's block whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Blocking of the Instance/Company ${company_block} carried out successfully...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Let's Unblock whaticket...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Unlocking the Instance/Company ${empresa_desbloquear} carried out successfully...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Let's Change whaticket Domains...${GRAY_LIGHT}"
  printf "\n\n"
...
EOF
  ...
  print_banner
  printf "${WHITE} 💻 Domain change of the Instance/Company ${company_domain} carried out successfully...${GRAY_LIGHT}"
  printf "\n\n"
...
system_nginx_conf() {
  print_banner
  printf "${WHITE} 💻 configuring nginx...${GRAY_LIGHT}"
  printf "\n\n"
...
system_certbot_setup() {
  print_banner
  printf "${WHITE} 💻 Configuring certbot, We're close to the end...${GRAY_LIGHT}"
  printf "\n\n"
